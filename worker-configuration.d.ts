/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 63f0d35895dd74017161e5d73fa3b9d8)
// Runtime types generated with workerd@1.20260120.0 2025-12-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
	}
	interface WorkerProdEnv {
		KV_SAVE: KVNamespace;
		KV_POENINJA: KVNamespace;
		URL: "";
		ENVIRONMENT: "prod";
	}
	interface WorkerDevEnv {
		KV_SAVE: KVNamespace;
		KV_POENINJA: KVNamespace;
		URL: "";
		ENVIRONMENT: "dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "URL" | "ENVIRONMENT">> {}
}
