...
- KV namespaces: `KV_SAVE` (shared sets), `KV_POENINJA` (cached price data)
...
- Cron trigger runs every 15 minutes to update scarab prices from poe.ninja (see `app/scheduled/`)
